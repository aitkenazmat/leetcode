...
public class PdfGenerator2 {
  public static void main(String[] args) {
    ...
    try {
      ...
      // Можно, например, сохранить в файл (опционально)
      try (FileOutputStream fos = new FileOutputStream("Извещение222.pdf")) {
        fos.write(pdfBytes);
      }

      System.out.println("PDF сгенерирован в памяти и сохранён при необходимости.");
